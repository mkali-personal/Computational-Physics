    ...
    def run_simulation(self):
        ...
        while focused_stuention < len(recorder) and students_created < n:
            ...
            if recorder[focused_stuention][3] == 1:
                ...
                base_studention = copy.copy(recorder[focused_stuention])
                recorder[focused_stuention] = self.reset_studention(base_studention)
                recorder.append(self.reset_studention(base_studention))
                students_created += 2
            else:
                focused_stuention += 1
